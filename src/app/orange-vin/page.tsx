...
export default function Orangevin() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      const producers = Array.from(new Set(allOrangeVine.map((vin) => vin.producent))) as string[];

      setProductData(allOrangeVine); // Gem original data
      setFilteredData(allOrangeVine); // Viser kun Orangevine på siden

    ...
    <section className="w-full group relative pb-4 min-w-[300px] md:min-w-[450px] overflow-hidden">
      ...
      >
        ...
        <div className="swiper-button-prev custom-arrow-prev">
          <div className="bg-primary/60 hover:bg-bg  text-bg group-hover:opacity-100 transition-opacity  duration-200 hover:opacity-100 hover:text-primary rounded-full w-8 h-8 md:w-12 md:h-12  justify-center items-center aspect-square hidden md:flex">

    ...
    <div className="relative min-h-12">
      <Listbox value={selectedItems} onChange={setSelectedItems} multiple>
        ...
        <Transition show={open} leave="transition ease-in duration-100" leaveFrom="opacity-100" leaveTo="opacity-0">
          <ListboxOptions className={clsx("absolute mt-1 max-h-60 w-52 md:w-72 overflow-auto rounded-md border-2 border-primary bg-bg shadow-lg z-50 left-0 top-full", "transform translate-y-0")}>

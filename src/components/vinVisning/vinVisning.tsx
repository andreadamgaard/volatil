        ...
        <article key={vin.sku} className="flex flex-col max-w-[30rem] ring-2 ring-primary rounded">
          <Link href={vin.handle} intent="wines" className="flex flex-col h-full max-w-[30rem]">
            <figure className="max-w-[30rem] h-auto ">
              <Image src={vin.image} alt={vin.title} width={2580} height={3855} className="w-full h-auto rounded-t object-cover" />
            </figure>
            <div className="flex flex-col justify-between flex-grow py-2.5 gap-y-1.5 px-2 md:py-4 md:gap-y-3 border-t-2 border-t-primary">

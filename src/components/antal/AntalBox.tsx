...
export const AntalBox = () => {
  return (
    <NumberField defaultValue={1} minValue={0} maxValue={15} className="flex flex-col gap-2">
      ...
      <Group className="ring-2 w-fit max-h-14 rounded ring-primary transition ease-in-out duration-200 flex justify-center items-center">
        <Input className="w-10 font-hackney text-4xl flex text-center outline-none focus:ring-1 focus:ring-primary" />

...
export const Alle = () => {
  return (
    <div className="flex flex-col w-full h-full py-4 px-6 text-base font-bold gap-y-4 justify-center items-center">
      <Link href="/alle-vine/" intent="null" aria-label="Alle vine">
        <span className="flex flex-col gap-y-4">
          ...
          <span className="hover:scale-105 transition ease-in-out duration-200 group w-full flex justify-center items-center">
